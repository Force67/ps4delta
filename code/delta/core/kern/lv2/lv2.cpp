...
namespace krnl
{
	...
	static uintptr_t emit_calltrace(const char *name, uint32_t sid, const void *dest)
	{
		...
		callTrace* gen = new callTrace(reinterpret_cast<uintptr_t>(name), sid, reinterpret_cast<uintptr_t>(dest));
